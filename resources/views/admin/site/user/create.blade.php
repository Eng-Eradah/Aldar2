...
@section('content')
    <div class="side-app">
        ...
        <div class="col-lg-12 col-md-12 col-md-12 ">
            ...
            @if (isset($data->id))
                <form class="card" method="POST" action="{{ route('add_user', $data->id) }}"
                    enctype="multipart/form-data">
                @else
                    <form class="card" method="POST" action="{{ route('add_user') }}" enctype="multipart/form-data">
            @endif
            @csrf
            <div class="row m-2">
                <div class="col-md-12 ">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" value="@if(isset($data->id)){{ $data->name }}@else{{ old('name') }}@endif" placeholder="الاسم">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="form-label text-dark"> الايميل </label>

                            <input type="text" name="email" class="form-control" value="@if(isset($data->id)){{ $data->email }}@else{{ old('email') }}@endif" placeholder="الايميل ">
                                <span id="c_nameArError" class="jsError" role="alert"></span>
                                @error('email')
                                    <div class=" text-danger">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="inputState" class="col-form-label">الصلاحيات</label>
