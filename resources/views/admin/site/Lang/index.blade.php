...
<div class="side-app mt-5">
    ...
    <button type="button" class="btn btn-primary" ><a href="{{route('addlang')}}" class="text-white"><i class="fe fe-plus mr-2"></i>{{ __('system.add') }}</a></button>
    </div>
    <!-- /Page Header-->
                    ...
                    <div class="col-lg-12 col-md-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table class="table table-bordered border-top mb-0  w-100 table-responsive">
                                    <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                ...
                                                <div class="btn-group">
                                                    <a href="{{route('addlang',$data->id)}}" class="btn btn-info"><i class="fa fa-edit"></i></a>
                                                
                                                    @if($data->is_active==1)
                                                    <a href="{{route('toggle_lang',$data->id)}}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                                    @else
                                                    <a href="{{route('toggle_lang',$data->id)}}" class="btn btn-success"><i class="fa fa-check"></i></a>
                                                    @endif
