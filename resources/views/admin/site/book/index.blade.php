...
<div class="side-app mt-5">
    ...
    <button type="button" class="btn btn-primary" ><a href="{{route('addbook')}}" class="text-white"><i class="fe fe-plus mr-2"></i>{{ __('system.add') }}</a></button>
    </div>
    <!-- /Page Header-->
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                ...
                                                <div class="btn-group">
                                                    <a href="{{route('addbook',$data->id)}}" class="btn btn-info"><i class="fa fa-edit"></i></a>
                                                
                                                    @if($data->is_active==1)
                                                    <a href="{{route('toggle_book',$data->id)}}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                                    @else
                                                    <a href="{{route('toggle_book',$data->id)}}" class="btn btn-success"><i class="fa fa-check"></i></a>
                                                    @endif
