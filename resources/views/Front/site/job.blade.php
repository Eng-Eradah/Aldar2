                                    ...
                                    <div class="col-xl-4 col-lg-4">
                                        <div class="pricing__single">
                                            <div class="pricing-shape-1">
                                                <img src="{{asset('/front/images/shapes/pricing-shape-1.png')}}" alt="">
                                            </div>
                                            <div class="pricing__single-top" style="width:100%">
                                                <div class="pricing__img" style="width:100%">
                                                    <img src="{{asset('/front/images/resources/pricing-img-2.png')}}"  style="width:100%" alt="">
                                                </div>
                                                
                                               
                                            </div>
                                            <div class="pricing__content mt-5">
                                                <p style="display: inline; "><i class="far fa-calendar "  style="margin-left: 20px" ></i>{{$data->start_date}}</p>
                                                <p style="display: inline; "><i class="far fa-calendar " style="margin-left: 20px"></i>{{$data->end_date}}</p>
                                            </div>
                                            <div class="pricing__single-bottom">
                                                ...
                                                <div class="pricing__btn-box">
                                                    <a href="{{route('event.details',$data->id)}}" class="thm-btn pricing__btn">{{__('website.apply')}}</a>
                                                    <a href="{{route('job.details',$data->id)}}" class="thm-btn pricing__btn">{{__('website.details')}}</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
