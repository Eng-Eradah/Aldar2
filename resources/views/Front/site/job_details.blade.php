                        ...
                        <div class="news-details__left">
                            ...
                            <div class="news-details__content">
                                <ul class="list-unstyled news-details__meta">
                                    <li style="margin-left: 30px"><a href=""><i class="far fa-calendar"></i> {{$item->start_date}} </a>
                                    </li>
                            ...
                            <div class="pricing__btn-box">
                                <a href="{{route('job.details',$item->id)}}" class="thm-btn pricing__btn">{{__('website.apply')}}</a>
                            </div>
                                ...
                                <ul class="sidebar__post-list list-unstyled">
                                    ...
                                    <li>
                                        ...
                                        <div class="sidebar__post-content">
                                            <h3>
                                                <span class="sidebar__post-content-meta"><i class="far fa-calendar"></i> {{$data->end_date}} </span>
                                                <a href="">{{$data->title}}</a>
                                            </h3>
                                        </div>
                                    </li>
