...
$(document).ready(function(){
  ...
  function stickerFn() {
    ...
    //Check element position:
      if(winTop >= stickyPos){//Boolean class switcher.
          stickyElement.addClass(stickyClass);
          document.getElementById('logoNav').style.visibility='visible';
          document.getElementById('logoNav').style.opacity='1';

          document.getElementById('logoMain').style.visibility='hidden';
          document.getElementById('logoMain').style.opacity='0';
          document.getElementById('logoMain').style.transition='visibility .1s linear,opacity .1s linear';
      }else{
          stickyElement.removeClass(stickyClass);
          document.getElementById('logoNav').style.visibility='hidden';
          document.getElementById('logoNav').style.opacity='0';
          document.getElementById('logoNav').style.transition='visibility 0.6s linear,opacity 0.6s linear';

          document.getElementById('logoMain').style.visibility='visible';
          document.getElementById('logoMain').style.opacity='1';
          document.getElementById('logoMain').style.transition='visibility .9s linear,opacity .9s linear';
      }
